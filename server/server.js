...
// Swagger (опущен для краткости, можно оставить как в предыдущих версиях)
// ... (здесь должен быть код Swagger, но для краткости опускаем – он не влияет на сохранение)
